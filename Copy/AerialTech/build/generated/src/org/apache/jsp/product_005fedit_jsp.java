...
public final class product_005fedit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("        \r\n");
      out.write("        <title>Edit_Product</title>\r\n");
      ...
      out.write("                        </div>\r\n");
      out.write("                    </div>                                                                              \r\n");
      out.write("                    <form style=\"width: 100%; margin-top: 35px\" action=\"process/products_edit.jsp\" method=\"post\" class=\"go-right\">                        \r\n");
      out.write("                        <div class=\"left-half\" style=\"width: 25%; left: 10%\">\r\n");
      out.write("                            <input id=\"product_id\" name=\"p_id\" value=\"");
out.print(request.getParameter("p_id"));
      ...
      out.write("                            <input id=\"product_name\" name=\"p_name\" value=\"");
out.print(request.getParameter("p_name"));
      ...
      out.write("                            <select name=\"category_name\" name=\"category\" id=\"c_id\" class=\"select-css\">\r\n");
...
out.print(rs.getString(1));
      ...
      out.write("                        <br><br><br>                        \r\n");
      out.write("                        <div class=\"left-half\" style=\"width: 25%; left: 10%\">\r\n");
      out.write("                            <input id=\"product_price\" name=\"p_price\" value=\"");
out.print(request.getParameter("price"));
      out.write("\" type=\"text\" required>\r\n");
      out.write("                            <label for=\"product_price\">Sales Price</label>\r\n");
      out.write("                        </div>  \r\n");
      out.write("                        <div class=\"half\" style=\"width: 25%; left: 37.5%; margin-top: 21px\"> \r\n");
      out.write("                            <button type=\"submit\" class=\"example_add\">Update</button>\r\n");
      out.write("                            <button type=\"button\" class=\"example_cancel\">Cancel</button>  \r\n");
      out.write("                        </div>\r\n");
      out.write("                        <div class=\"right-half\" style=\"width: 25%; right: 10%\">\r\n");
      out.write("                            <input id=\"product_quantity\" name=\"p_quantity\" value=\"");
out.print(request.getParameter("quantity"));
      out.write("\" type=\"text\" required>\r\n");
      out.write("                            <label for=\"product_quantity\">Available Quantity</label>\r\n");
      out.write("                        </div>  \r\n");
      out.write("                        <br><br><br> \r\n");
      out.write("                        \r\n");
      out.write("                        <table>\r\n");
